...
export default function WorldCup() {
  ...
  if (!totalRound) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#050505] text-white p-4 relative overflow-hidden text-center">
        ...
        <h1 className="text-8xl md:text-[12rem] font-black mb-12 tracking-tighter italic uppercase text-white leading-[0.8] z-10">K-POP <br/><span className="text-red-600">BIAS</span></h1>
        ...
        <div className="grid grid-cols-2 gap-4 w-full max-w-md mb-16 z-10">
          {[32, 64, 128, 256].map(r => (
            <button key={r} onClick={() => startWorldCup(r)} className="group bg-zinc-900/50 border border-zinc-800 p-8 rounded-[2.5rem] hover:border-red-600 active:scale-95 transition-all backdrop-blur-sm">
              ...
              <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest uppercase">EMPEZAR</span>
            </button>
          ))}
        </div>
        <RankingChart />
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-black text-white p-2 overflow-hidden relative">
